defmodule CloneOS.System.Updates do
  @moduledoc """
  ...
  defp releases_url do
    {:ok, token} = CloneOS.Auth.get_token()
  ...
  def do_update_check do
    if CloneOS.BotState.get_config(:os_auto_update) do
  ...
  def check_updates do
    current = CloneOS.BotState.get_os_version
