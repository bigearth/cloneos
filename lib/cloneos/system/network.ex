defmodule CloneOS.System.Network do
  @moduledoc """
    Network functionality.
  """
  require Logger
  use GenServer
  alias CloneOS.System.FS.ConfigStorage, as: CS
  alias CloneOS.System.Network.SSH
  alias CloneOS.System.Network.Ntp
  alias CloneOS.Auth

  @access_token Application.get_env(:cloneos, :rollbar_access_token)
  ...
  def on_connect(fun \\ nil) do
    Supervisor.start_child(CloneOS.System.Supervisor,
