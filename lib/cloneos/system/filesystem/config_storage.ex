defmodule CloneOS.System.FS.ConfigStorage do
  @moduledoc """
  ...
  """
  use GenServer
  alias CloneOS.System.FS.ConfigFileMigrations, as: CFM
  require Logger

  @config_file Application.get_env(:cloneos, :path) <> "/config.json"
  @default_config_file_name Application.get_env(:cloneos, :config_file_name)
  defp default_config_file,
    do: "#{:code.priv_dir(:cloneos)}/configs/#{@default_config_file_name}"
