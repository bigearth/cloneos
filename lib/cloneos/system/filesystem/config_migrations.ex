defmodule CloneOS.System.FS.ConfigFileMigrations do
  @moduledoc """
    Migrates a state map to the current form.

    # Heres how they work
      * this module lists all the files in "#{:code.priv_dir(:cloneos)}/migrations"
  ...
  require Logger
  @save_dir Application.get_env(:cloneos, :path)
  ...
  defp migrations_dir, do: "#{:code.priv_dir(:cloneos)}/migrations"
