defmodule CloneOS.Configurator.SocketHandler do
  @moduledoc """
  ...
  # it does. I could make it an atom: :"Elixir.CloneOS.Transport.WebScoket",
  # but that is kind of ugly.
  alias CloneOS.Transport.WebSocket, as: WSTransport
  # alias CloneOS.Transport.Serialized, as: Ser
