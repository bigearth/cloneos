defmodule Mix.Tasks.Cs.New do
  ...
  def run([new_cs]) do
    ...
    new_cs_path = "lib/cloneos/celery_script/commands/#{new_cs}.ex"
    new_cs_test_path = "test/cloneos/celery_script/commands/#{new_cs}_test.exs"
  ...
  defp build_test_module(camelized_kind) do
    """
    defmodule CloneOS.CeleryScript.Command.#{camelized_kind}Test do
      use ExUnit.Case
      alias CloneOS.CeleryScript.Ast
      alias CloneOS.CeleryScript.Command
  ...
  defp build_module(camelized_kind) do
    """
    defmodule CloneOS.CeleryScript.Command.#{camelized_kind} do
