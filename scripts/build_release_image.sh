...
FIRM_FILE=_build/$SYSTEM/$MIX_ENV/nerves/images/cloneos.fw  # the .fw file generated by `mix firmware`
FIRM_FILE_REL=$REL_DIR/cloneos-$SYSTEM-$VERSION.fw # where we want our formatted system
FIRM_FILE_REL_IMG=$REL_DIR/cloneos-$SYSTEM-$VERSION.img # same as the above file, but a .img file
